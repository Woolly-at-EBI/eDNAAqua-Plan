...
def get_metadata_preknown_dict():
    metadata_preknown_dict = {
        ...
        "DB_name": {"value": {"INSDC": ["ENA","GenBank","DDBJ"]}, "example": "ENA", "comment": "Almost all records are shared amounts INDSC members"},
        ...
        "sequences_processed": {"value": "both", "example": "", "comment": "Both raw and processed sequences"},
