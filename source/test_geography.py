...
class TestGeography(unittest.TestCase):
    ...
    def test_clean_insdc_country_term(self):
        self.assertEqual(self.geography.clean_insdc_country_term('France'),'France')
        self.assertEqual(self.geography.clean_insdc_country_term('FRANCE:Paris'), 'France')
        self.assertEqual(self.geography.clean_insdc_country_term('Antigua and barbuda'), 'Antigua and Barbuda')
